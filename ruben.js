import { default as zkpInit } from '@vulpemventures/secp256k1-zkp';
...
const endpoint = 'https://api.regtest.getbittr.com';
const webSocketEndpoint = 'wss://api.regtest.getbittr.com';

// Amount you want to swap
const invoiceAmount = 50_000;

// Address to which the swap should be claimed
const destinationAddress = 'bcrt1qr8sqyhmq0ulgumt28znlnz5dy6wkl564r65swh';
