...
extension secp256k1.MuSig {
    ...
    public static func aggregate(_ pubkeys: [secp256k1.Schnorr.PublicKey], format: secp256k1.Format) throws -> secp256k1.MuSig.PublicKey {
...
public extension secp256k1.Schnorr {
    struct PartialSignature: ContiguousBytes {
        ...
        public init(hexString: String, session: Data) throws {
            ...
            var serializedPartialSig = [UInt8](repeating: 0, count: secp256k1.ByteLength.partialSignature)
            ...
            self.dataRepresentation = Data(serializedPartialSig)
